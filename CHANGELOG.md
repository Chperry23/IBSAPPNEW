...
### Added
- Sign-in page shows “This is a test” so a tablet can confirm an in-app update
...
- Tablet update feed (`cabinet-pm.env` + `version.json`): online check on startup and Sync, then a one-click installer upgrade that does not replace the AppData database
...
[Unreleased]: https://github.com/Chperry23/IBSAPPNEW/compare/v2.0.4...develop
...
[2.0.2]: https://github.com/Chperry23/IBSAPPNEW/compare/v2.0.1...v2.0.2
[2.0.3]: https://github.com/Chperry23/IBSAPPNEW/compare/v2.0.2...v2.0.3
[2.0.4]: https://github.com/Chperry23/IBSAPPNEW/compare/v2.0.3...v2.0.4
