  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-[#252542] hover:bg-[#2f2f4d] border border-[#3d3d5c] hover:border-blue-500/50 text-gray-300 hover:text-white text-sm font-medium shadow-md shadow-black/20 transition-all focus:outline-none focus:ring-2 focus:ring-blue-500"
        title="Search (Ctrl+K)"
      >
        <span>🔍</span>
